...
int main(int argc, char **argv) {
	...
	for(i=0;i<=50;i++)
	{
		...
		double krok_czasowy = rand()%10*3.21423423+1;
		double dlugosc_symulacji = rand()%1000000*1.233213213+4000;
		char *in = t;
		char *out = "wynik.txt";
		...
		for(c = 0; c < krok_czasowy*3600/dlugosc_symulacji; c++){
			for(i = 0; i < n; i++){
